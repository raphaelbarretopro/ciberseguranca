...
export let matriculaUsuario = ""; // Novo: guarda a matrícula do usuário
...
function mostrarModalNomeUsuario() {
  ...
  modal.innerHTML = `
    <div style="background:#fff;padding:30px;border-radius:8px;max-width:350px;text-align:center;">
      ...
      <input type="text" id="inputMatriculaUsuario" placeholder="Digite sua matrícula" style="width:90%;padding:10px;margin:10px 0;" />
      <input type="text" id="inputNomeUsuario" placeholder="Digite seu nome completo" style="width:90%;padding:10px;margin:10px 0;" />
      <br>
      <button id="btnConfirmarNomeUsuario" style="padding:10px 30px;">Iniciar Avaliação</button>
    </div>
  `;
  document.body.appendChild(modal);
  document.getElementById('btnConfirmarNomeUsuario').onclick = () => {
    const matricula = document.getElementById('inputMatriculaUsuario').value.trim();
...
function mostrarResultadoFinal() {
  ...
  <h2 style="margin-bottom: 10px; color: #007bff;">Matrícula: ${matriculaUsuario ? matriculaUsuario : 'Matrícula não informada'}</h2>
  <h2 style="margin-bottom: 10px; color: #007bff;">Aluno: ${nomeUsuario ? nomeUsuario : 'Nome não informado'}</h2>
      ...
      <h1>Desempenho por seção da Avaliação</h1>
